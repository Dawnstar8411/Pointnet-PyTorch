...
parser.add_argument('--seed', default=1024, type=int, help="seed for random function and network initialization.")

# 读取与保存
parser.add_argument('--data_path', default='/home/yc/chen/data/Pointnet/indoor3d_sem_seg_hdf5_data/', metavar='DIR', help='path to dataset')
...
parser.add_argument('--batch_size',default=24,type=int, help="Batch Size during training")
...
parser.add_argument('--decay_step', default=20, type=int, help="Decay step for lr decay")
