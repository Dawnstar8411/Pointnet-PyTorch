...
with open('./meta/class_names.txt', "r") as f:
    g_classes = [line.rstrip() for line in f.readlines()]
...
def collect_point_label(anno_path, out_filename, file_format='txt'):
    ...
    for f in glob.glob(os.path.join(anno_path, '*.txt')):
        ...
        points_list.append(np.concatenate([points, labels], 1))  # N*7  XYZRGBL  L means 'label'
